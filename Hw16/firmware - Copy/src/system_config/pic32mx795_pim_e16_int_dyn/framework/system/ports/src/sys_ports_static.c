...
void SYS_PORTS_Initialize(void)
{
    ...
    PLIB_PORTS_DirectionOutputSet( PORTS_ID_0, PORT_CHANNEL_B,  SYS_PORT_A_TRIS ^ 0xFFFF);
    PLIB_PORTS_Toggle( PORTS_ID_0, PORT_CHANNEL_B,  SYS_PORT_A_LAT);
    PLIB_PORTS_OpenDrainEnable(PORTS_ID_0, PORT_CHANNEL_B, SYS_PORT_A_ODC);
